...
export const UserAuth = ({ isOpen, setIsOpen }: Props) => {
  ...
  return (
    <>
      <ProviderAuth openAuth={isOpen} setOpenAuth={setIsOpen} />
    </>
  );

  // OLD METHOD: WITH EMAIL AND PASSWORD, DECIDED TO PROCEED WITH GOOGLE API FOR NOW.
  // return (
  //   <>
  //     <AnimatePresence>
  //       {isOpen && (
  ...
  //             className="m-auto w-full md:w-[70%] lg:w-[35%] h-fit p-4 md:p-8 lg:p-12 bg-gray-500 bg-opacity-60 backdrop-blur-md border border-transparent border-opacity-50 rounded-lg shadow-lg"
  //           >
  //             {/* CLOSE BUTTON */}
