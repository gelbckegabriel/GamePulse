...
export const CardCarousel = ({ items, initialScroll = 0 }) => {
  ...
  return (
    <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className="relative w-full">
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto py-10 md:pt-20 md:pb-10 scroll-smooth [scrollbar-width:none]"
          ref={carouselRef}
        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            <motion.div
              ...
              className="max-w-5xl mx-auto bg-background/40 h-fit z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative"
            >
              <button className="sticky top-4 h-8 w-8 right-0 ml-auto bg-white rounded-full flex items-center justify-center" onClick={handleClose}>
              ...
              <motion.p
                ...
                className="text-2xl md:text-4xl font-semibold text-neutral-700 mt-4 text-white"
              >
                {card.title}
              </motion.p>
